      ...
      >
        ...
        >
          <div className="flex justify-center mb-6">
            <LogoIcon size={130} animate />
          </div>
          <h1 className="text-6xl md:text-7xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-pink-400 via-purple-400 to-indigo-400">
            Momentum
          </h1>
        ...
        >
          <motion.div 
            className="backdrop-blur-lg bg-white/5 border border-white/10 rounded-xl px-8 py-5 text-center shadow-xl"
            whileHover={{ y: -5, boxShadow: "0 20px 25px -5px rgba(124, 58, 237, 0.1)" }}
            transition={{ type: "spring", stiffness: 500, damping: 15 }}
          >
            <div className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-pink-200 mb-1">100%</div>
          ...
          <motion.div 
            ...
            transition={{ type: "spring", stiffness: 500, damping: 15 }}
          >
            <div className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-blue-200 mb-1">AI</div>
        ...
        >
          <motion.div 
            className="backdrop-blur-lg bg-white/5 border border-white/10 rounded-2xl p-6 shadow-xl relative overflow-hidden group"
          ...
          >
            ...
            <div className="text-pink-400 mb-4 relative">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" viewBox="0 0 20 20" fill="currentColor">
                <path fillRule="evenodd" d="M2.166 4.999A11.954 11.954 0 0010 1.944 11.954 11.954 0 0017.834 5c.11.65.166 1.32.166 2.001 0 5.225-3.34 9.67-8 11.317C5.34 16.67 2 12.225 2 7c0-.682.057-1.35.166-2.001zm11.541 3.708a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
              </svg>
            </div>
            <h3 className="text-xl font-semibold mb-3 text-white">Secure & Verified</h3>
          ...
          >
            ...
            <h3 className="text-xl font-semibold mb-3 text-white">Personal AI Assistant</h3>
          ...
          >
            ...
            <div className="text-purple-400 mb-4 relative">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" viewBox="0 0 20 20" fill="currentColor">
